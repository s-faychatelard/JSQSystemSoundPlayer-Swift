...
// In this header, you should import all the public headers of your framework using statements like #import <JSQSystemSoundPlayer/PublicHeader.h>
#import <JSQSystemSoundPlayer/SystemSoundHelper.h>